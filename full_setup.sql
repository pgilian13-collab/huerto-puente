-- ============================================================
-- MIGRACION: 5 Invernaderos x 4 Macetas x 3 Sensores = 60
-- Sensores por maceta: Temp(DHT22) + HumAmb(DHT22) + HumSuelo(ADS1115)
-- Actuadores: 4 por invernadero = 20
-- ============================================================

-- 1. Eliminar todo
DROP VIEW IF EXISTS vista_estado_actuadores CASCADE;
DROP VIEW IF EXISTS vista_ultimas_lecturas CASCADE;
DROP FUNCTION IF EXISTS marcar_offline() CASCADE;
DROP FUNCTION IF EXISTS registrar_historial() CASCADE;
DROP FUNCTION IF EXISTS actualizar_ultima_conexion() CASCADE;
DROP TABLE IF EXISTS historial_comandos CASCADE;
DROP TABLE IF EXISTS control_actuadores CASCADE;
DROP TABLE IF EXISTS monitoreo_lecturas CASCADE;
DROP TABLE IF EXISTS configuracion_umbrales CASCADE;
DROP TABLE IF EXISTS actuadores CASCADE;
DROP TABLE IF EXISTS sensores CASCADE;
DROP TABLE IF EXISTS dispositivos CASCADE;
DROP TABLE IF EXISTS tipos_actuadores CASCADE;
DROP TABLE IF EXISTS tipos_sensores CASCADE;
...
-- 4. Sensores (3 por maceta)
CREATE TABLE sensores (
    id SERIAL PRIMARY KEY,
    nombre VARCHAR(80) NOT NULL,
    pin_conexion VARCHAR(10) NOT NULL,
    maceta_num INT NOT NULL CHECK (maceta_num BETWEEN 1 AND 8),
...
BEGIN
    ...
    UPDATE actuadores
    SET estado_actual = NEW.estado_actual,
        ultimo_cambio = NOW()
...
-- Solo 3 tipos de sensores (sin pH)
...
-- 10. Sensores: 4 macetas x 3 sensores x 5 inv = 60
-- tipo_sensor_id: 1=Temp, 2=HumAmb, 3=HumSuelo
-- Formula sensor_id: (dispositivo_id-1)*12 + (maceta-1)*3 + tipo

INSERT INTO sensores (nombre, pin_conexion, maceta_num, dispositivo_id, tipo_sensor_id) VALUES
-- INV1
('INV1-M1-Temp',  'GPIO4',  1, 1, 1), ('INV1-M1-HumAmb', 'GPIO4',  1, 1, 2), ('INV1-M1-HumSuelo', 'A0', 1, 1, 3),
('INV1-M2-Temp',  'GPIO15', 2, 1, 1), ('INV1-M2-HumAmb', 'GPIO15', 2, 1, 2), ('INV1-M2-HumSuelo', 'A1', 2, 1, 3),
('INV1-M3-Temp',  'GPIO16', 3, 1, 1), ('INV1-M3-HumAmb', 'GPIO16', 3, 1, 2), ('INV1-M3-HumSuelo', 'A2', 3, 1, 3),
('INV1-M4-Temp',  'GPIO17', 4, 1, 1), ('INV1-M4-HumAmb', 'GPIO17', 4, 1, 2), ('INV1-M4-HumSuelo', 'A3', 4, 1, 3),
-- INV2
('INV2-M1-Temp',  'GPIO4',  1, 2, 1), ('INV2-M1-HumAmb', 'GPIO4',  1, 2, 2), ('INV2-M1-HumSuelo', 'A0', 1, 2, 3),
('INV2-M2-Temp',  'GPIO15', 2, 2, 1), ('INV2-M2-HumAmb', 'GPIO15', 2, 2, 2), ('INV2-M2-HumSuelo', 'A1', 2, 2, 3),
('INV2-M3-Temp',  'GPIO16', 3, 2, 1), ('INV2-M3-HumAmb', 'GPIO16', 3, 2, 2), ('INV2-M3-HumSuelo', 'A2', 3, 2, 3),
('INV2-M4-Temp',  'GPIO17', 4, 2, 1), ('INV2-M4-HumAmb', 'GPIO17', 4, 2, 2), ('INV2-M4-HumSuelo', 'A3', 4, 2, 3),
-- INV3
('INV3-M1-Temp',  'GPIO4',  1, 3, 1), ('INV3-M1-HumAmb', 'GPIO4',  1, 3, 2), ('INV3-M1-HumSuelo', 'A0', 1, 3, 3),
('INV3-M2-Temp',  'GPIO15', 2, 3, 1), ('INV3-M2-HumAmb', 'GPIO15', 2, 3, 2), ('INV3-M2-HumSuelo', 'A1', 2, 3, 3),
('INV3-M3-Temp',  'GPIO16', 3, 3, 1), ('INV3-M3-HumAmb', 'GPIO16', 3, 3, 2), ('INV3-M3-HumSuelo', 'A2', 3, 3, 3),
('INV3-M4-Temp',  'GPIO17', 4, 3, 1), ('INV3-M4-HumAmb', 'GPIO17', 4, 3, 2), ('INV3-M4-HumSuelo', 'A3', 4, 3, 3),
-- INV4
('INV4-M1-Temp',  'GPIO4',  1, 4, 1), ('INV4-M1-HumAmb', 'GPIO4',  1, 4, 2), ('INV4-M1-HumSuelo', 'A0', 1, 4, 3),
('INV4-M2-Temp',  'GPIO15', 2, 4, 1), ('INV4-M2-HumAmb', 'GPIO15', 2, 4, 2), ('INV4-M2-HumSuelo', 'A1', 2, 4, 3),
('INV4-M3-Temp',  'GPIO16', 3, 4, 1), ('INV4-M3-HumAmb', 'GPIO16', 3, 4, 2), ('INV4-M3-HumSuelo', 'A2', 3, 4, 3),
('INV4-M4-Temp',  'GPIO17', 4, 4, 1), ('INV4-M4-HumAmb', 'GPIO17', 4, 4, 2), ('INV4-M4-HumSuelo', 'A3', 4, 4, 3),
-- INV5
('INV5-M1-Temp',  'GPIO4',  1, 5, 1), ('INV5-M1-HumAmb', 'GPIO4',  1, 5, 2), ('INV5-M1-HumSuelo', 'A0', 1, 5, 3),
('INV5-M2-Temp',  'GPIO15', 2, 5, 1), ('INV5-M2-HumAmb', 'GPIO15', 2, 5, 2), ('INV5-M2-HumSuelo', 'A1', 2, 5, 3),
('INV5-M3-Temp',  'GPIO16', 3, 5, 1), ('INV5-M3-HumAmb', 'GPIO16', 3, 5, 2), ('INV5-M3-HumSuelo', 'A2', 3, 5, 3),
('INV5-M4-Temp',  'GPIO17', 4, 5, 1), ('INV5-M4-HumAmb', 'GPIO17', 4, 5, 2), ('INV5-M4-HumSuelo', 'A3', 4, 5, 3);

-- 11. Actuadores
INSERT INTO actuadores (nombre, pin_conexion, dispositivo_id, tipo_actuador_id) VALUES
('bomba',        'GPIO13', 1, 1), ('pulverizador', 'GPIO14', 1, 2),
('ventilador',   'GPIO5',  1, 3), ('buzzer',       'GPIO26', 1, 4),
('bomba',        'GPIO13', 2, 1), ('pulverizador', 'GPIO14', 2, 2),
('ventilador',   'GPIO5',  2, 3), ('buzzer',       'GPIO26', 2, 4),
('bomba',        'GPIO13', 3, 1), ('pulverizador', 'GPIO14', 3, 2),
('ventilador',   'GPIO5',  3, 3), ('buzzer',       'GPIO26', 3, 4),
('bomba',        'GPIO13', 4, 1), ('pulverizador', 'GPIO14', 4, 2),
('ventilador',   'GPIO5',  4, 3), ('buzzer',       'GPIO26', 4, 4),
('bomba',        'GPIO13', 5, 1), ('pulverizador', 'GPIO14', 5, 2),
('ventilador',   'GPIO5',  5, 3), ('buzzer',       'GPIO26', 5, 4);
