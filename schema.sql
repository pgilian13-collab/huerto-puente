...
-- Sensores: 4 macetas x 3 sensores x 5 inv = 60
...
(1, 'temperatura', 15, 30, '°C'), (1, 'humedad_suelo', 40, 80, '%'), (1, 'humedad_ambiente', 30, 85, '%'),
(2, 'temperatura', 15, 30, '°C'), (2, 'humedad_suelo', 40, 80, '%'), (2, 'humedad_ambiente', 30, 85, '%'),
(3, 'temperatura', 15, 30, '°C'), (3, 'humedad_suelo', 40, 80, '%'), (3, 'humedad_ambiente', 30, 85, '%'),
(4, 'temperatura', 15, 30, '°C'), (4, 'humedad_suelo', 40, 80, '%'), (4, 'humedad_ambiente', 30, 85, '%'),
(5, 'temperatura', 15, 30, '°C'), (5, 'humedad_suelo', 40, 80, '%'), (5, 'humedad_ambiente', 30, 85, '%');
...
SELECT a.id AS actuador_id, a.nombre AS actuador, ta.nombre AS tipo,
       a.pin_conexion, a.estado_actual, a.ultimo_cambio,
       d.nombre AS dispositivo, sec.nombre AS sector
FROM actuadores a
